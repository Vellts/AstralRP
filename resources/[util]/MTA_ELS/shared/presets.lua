...
tblELSPresets = {
    ...
    [599] = { -- Police Ranger
        ...
        lights = {
            --top
            {x = -0.65,    y = -0.1, z = 0.98, rz = 50, color = {255,0,0}, start = 0,  stop = 200, size = 1},
            {x = -0.65,    y = -0.55, z = 0.98, rz = 130, color = {255,0,0}, start = 200,  stop = 400, size = 1},
            {x = 0.65,    y = -0.09, z = 1, rz = -50, color = {0,0,255}, start = 0,  stop = 200, size = 1},
            {x = 0.65,    y = -0.55, z = 1, rz = -130, color = {0,0,255}, start = 200,  stop = 400, size = 1},
            -- IDK --
