...
instance.types = {
    ['full'] = 'files/imgs/full.png';
    ['default'] = 'files/imgs/default.png';
}
...
function Colorpicker:render ()
    ...
    dxDrawImage (self.x, self.y, self.width, self.height, instance.types[self.type], 0, 0, 0, tocolor (255, 255, 255, self.animation and self.animation.alpha or 255), self.postGUI);
    dxDrawImage (self.cursorx, self.cursory, self.cursor.x, self.cursor.y, 'files/imgs/cursor.png', 0, 0, 0, tocolor (255, 255, 255, self.animation and self.animation.alpha or 255), self.postGUI);
